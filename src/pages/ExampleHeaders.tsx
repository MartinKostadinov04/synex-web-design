...
const HeaderC3 = () => (
  <div className="relative isolate overflow-hidden border-b border-border bg-background py-16 sm:py-20">
    ...
    >
      <defs>
        <pattern id="header-c3-grid" x="50%" y={-1} width={200} height={200} patternUnits="userSpaceOnUse">
      ...
      <rect fill="url(#header-c3-grid)" width="100%" height="100%" strokeWidth={0} />
    </svg>
    {/* Gradient blob */}
    <div
      aria-hidden="true"
