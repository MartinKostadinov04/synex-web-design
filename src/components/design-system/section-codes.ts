...
export const heroGridBgCode = `// HeroGridBackground
...
export const faqSectionCode = `import {
  Accordion,
  AccordionContent,
  AccordionItem,
  AccordionTrigger,
...
export const notFoundCode = `import { useLocation, Link } from "react-router-dom";
