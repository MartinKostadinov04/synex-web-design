...
const benefits = [
  {
    ...
    description: "Stay ahead of regulations and avoid penalties with expert support that ensures compliance with evolving legal and industry requirements.",
  },
  {
    icon: Timer,
    title: "Accelerate Time to Market",
    description: "Streamline EU market entry or continuity by navigating with expert support — reducing delays and enabling confident, compliant operations.",
  },
  {
    icon: CircleDollarSign,
    title: "Avoid Hidden Costs",
    description: "Prevent costly reworks and missed opportunities by addressing compliance early, turning complex requirements into operational clarity and efficiency.",
  },
  {
    icon: Route,
    title: "Tailored Compliance Roadmaps",
    description: "Get customized, step-by-step regulatory plans aligned with your business needs and goals — focused, actionable, and growth-oriented.",
  },
];
...
const services = [
  {
    ...
    description: "Navigate complex EU battery rules with expert guidance on compliance strategy, data requirements, labeling, and digital battery passport implementation.",
    href: "/batteryreg",
  },
  {
    title: "ESPR Consulting",
    description: "Get tailored support to align your products with ESPR, covering design requirements, DPP readiness, data strategy, and supply chain coordination.",
    href: "/espr",
  },
];
    ...
    <div className="mx-auto max-w-7xl px-6 lg:px-8">
      ...
      <div className="mx-auto mt-16 max-w-5xl grid grid-cols-1 gap-6 sm:grid-cols-2">
        {benefits.map((benefit) => (
          <div key={benefit.title} className="flex gap-4 rounded-xl border border-border bg-card p-6 shadow-sm">
      ...
      <div className="mx-auto mt-10 max-w-5xl grid grid-cols-1 gap-6 sm:grid-cols-2">
        {services.map((service) => (
          <div key={service.title} className="rounded-xl border border-border bg-card p-6 shadow-sm border-l-4 border-l-primary flex flex-col justify-between">
            <div>
